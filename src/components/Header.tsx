...
export default function Header({ 
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-brand-border bg-brand-bg/80 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-2 md:px-4 h-16 flex items-center justify-between gap-2 md:gap-4">
        <div className="flex items-center gap-8">
          <h1 className="text-2xl font-bold text-brand-primary whitespace-nowrap font-playful tracking-wide">
            Liga Positiva Dev2
          </h1>
          ...
          {!hideControls && (
            <>
              <button 
                ...
                className="flex items-center gap-2 bg-brand-primary hover:bg-brand-primary-hover text-brand-bg font-bold py-2 px-4 rounded-md transition-colors text-sm"
              >
                <Plus size={18} />
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2 px-4 rounded-md transition-colors text-sm"
          ...
          {user ? (
            <div className="flex items-center gap-2">
              ...
              <button 
                ...
                className="bg-brand-card hover:bg-red-500/10 text-gray-300 hover:text-red-500 px-3 py-1.5 rounded-md text-sm font-medium transition-colors border border-brand-border"
              >
                Sair
              </button>
            </div>
            ...
            <button 
              onClick={handleLogin}
              className="bg-brand-card hover:bg-brand-primary/10 text-brand-primary px-4 py-2 rounded-md text-sm font-bold transition-colors border border-brand-border"
            >
              Entrar
            </button>
          )}
